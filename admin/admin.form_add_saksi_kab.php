...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Tambah Data Saksi</h3>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="row">
    <div class="col-lg-12">
        <ul class="breadcrumb">
            ...
            <li><a href="?page=data_relawan_kab">Data Saksi</a></li>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <a href="?page=data_saksi_kab">
                    <button type="button" class="btn btn-outline btn-primary"><i class="fa fa-reply"></i>&nbsp;Lihat Data Saksi</button>
                </a>
            </div>
                    ...
                    <form role="form">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>ID Saksi</label>
                                <input class="form-control" placeholder="ID Saksi">
                                <p class="help-block">Nomor <strong>ID Saksi</strong> akan terisi secara otomatis.</p>
                            </div>
                            <div class="form-group">
                                <label>NIK</label>
                            ...
                            <div class="form-group">
                                <label>No. TPS</label>
                                <select class="form-control" id="notps">
                                    <option selected="selected" value="">-- No. TPS --</option>
                                <?php 
                                    foreach ($tps as $t) {
                                        echo '<option value="'.$t["id_tps"].'">'.$t["no_tps"].' - '.$t["nama_tps"].'</option>';
                                    }
                                ?>
                                </select>
                            </div>
